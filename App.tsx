...
import { AppState, BriefingContent, ShadowingFeedback, DiscussionFeedback, UserPreferences } from './types';
...
const App: React.FC = () => {
  ...
  const [currentState, setCurrentState] = useState<AppState>(
    loadPreferences().hasCompletedOnboarding ? AppState.TOPIC_SELECTION : AppState.ONBOARDING
  );
  ...
  const renderOnboarding = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto w-full p-4 sm:p-6 animate-fade-in">
  ...
  const renderListeningPhase = () => (
      <div className="max-w-2xl mx-auto w-full p-4 sm:p-6 flex flex-col items-center min-h-[60vh] text-center space-y-4 sm:space-y-6 animate-fade-in relative">
          ...
          {tooltip && (
            <div 
              ...
              style={{ 
                left: `${Math.min(Math.max(tooltip.x, 140), window.innerWidth - 140)}px`, 
                top: `${tooltip.y}px`, 
  ...
  const renderShadowingPhase = () => (
      <div className="max-w-2xl mx-auto w-full p-4 sm:p-6 flex flex-col gap-4 sm:gap-6 animate-fade-in h-full overflow-y-auto pb-20">
  ...
  const renderDiscussionPhase = () => (
      <div className="max-w-2xl mx-auto w-full p-4 sm:p-6 flex flex-col gap-6 sm:gap-8 animate-fade-in">
    ...
    <div className="h-full flex flex-col bg-slate-50">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {currentState === AppState.BRIEFING_GENERATION && (
            <div className="flex flex-col items-center justify-center h-full gap-4 text-slate-500 animate-pulse px-4">
